...
# La funcion Lambda se realiza para operaciones no complejas, por ejemplo para operaciones muy repetitivas
# Nada de bucles o cosas que tengan mayor complejidad
# Simplifica la operación y lo hace que sea más facil al utilizar dicha funcion anonima
# una un funcion lambda siempre se puede representar en una Def pero no siempre al contrario
