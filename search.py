...
def graph_search(problem, fringe):
    ...
    while fringe:
        ...
        if problem.goal_test(node.state):
            print("Numero de Nodos visitados : ", visitado)
            return node
...
def otra_first_graph_search(problem):
    """Search the deepest nodes in the search tree first. [p 74]"""
    print(" Ramificación y acotación")
    return graph_search(problem, Movi())

def otra2_first_graph_search(problem):
    """Search the deepest nodes in the search tree first. [p 74]"""
    print("Ramificación y acotacióbn con sub")
    return graph_search(problem, Movi2(problem))
